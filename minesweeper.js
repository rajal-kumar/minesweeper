...
var board = {
  cells: [
      ...
      {row:1, col:3, isMine:true,  hidden:true, surroundingMines:2 },
      {row:2, col:0, isMine:true,  hidden:true, surroundingMines:2 },
      ...
      {row:3, col:0, isMine:true,  hidden:true, surroundingMines:1 },
